...
import { NavigationItem, HelpersNavigationService } from 'helpers/components/navigation';
import { defaultNavigation } from 'helpers/navigation/navigation';
...
export class SearchMockApi
{
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._helpersNavigationService.getFlatNavigation(this._defaultNavigation);
